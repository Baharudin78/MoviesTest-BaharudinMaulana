...
import com.baharudin.moviestest.databinding.ActivityTopRatedMovieBinding
...
class TopRatedMovieActivity : AppCompatActivity() {
    ...
    private val binding : ActivityTopRatedMovieBinding by lazy {
        ActivityTopRatedMovieBinding.inflate(layoutInflater)
    }
